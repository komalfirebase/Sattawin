...
class LogoutFragment  : BaseFragment<HomeViewModel, FragmentSattaforumBinding, UserRepository>() {
    ...
    private fun webLoad() {
        ...
        binding.webview.setWebViewClient(object : WebViewClient() {
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                ...
                if(url.equals("https://sattawin.in/app/index.php?login")){
                    MyConstent.controll ="1"
                    startActivity(Intent(requireContext(), MainActivity::class.java))
                    requireActivity().finish()
                }else{
                    MyConstent.controll ="2"
                    view.loadUrl(url)
                }
                return true
            }
        ...
        binding.webview.loadUrl("https://sattawin.in/app/logout.php")
    }
}