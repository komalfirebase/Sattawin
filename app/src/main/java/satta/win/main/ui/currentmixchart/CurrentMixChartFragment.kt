...
class CurrentMixChartFragment  : BaseFragment<HomeViewModel, FragmentSattaforumBinding, UserRepository>() {
    ...
    private fun webLoad() {
        ...
        binding.webview.loadUrl("https://sattawin.in/app/currentmixchart.php")
    }
}