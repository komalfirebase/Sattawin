...
class GuesserForumFragment  : BaseFragment<HomeViewModel, FragmentSattaforumBinding, UserRepository>() {
    ...
    private fun webLoad() {
        ...
        binding.webview.loadUrl("https://sattawin.in/app/GuesserForum.php")
    }
}