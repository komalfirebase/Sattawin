...
class PrivacyFragment  : BaseFragment<HomeViewModel, FragmentSattaforumBinding, UserRepository>() {
    ...
    private fun webLoad() {
        ...
        binding.webview.loadUrl("https://sattawin.in/app/PrivacyPolicy.php")
    }
}